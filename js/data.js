...
export const meta = {
  ...
  chessUrl:      'https://www.chess.com/member/maxs02',
...
export const education = [
  {
    ...
    institution: { en: 'Università degli Studi di Padova — Padua, Italy', it: 'Università degli Studi di Padova — Padova, Italia' },
    period:      '2021 – present',
    description: {
...
export const hobbies = [
  {
    ...
    url:         'https://www.chess.com/member/maxs02',
    description: {
